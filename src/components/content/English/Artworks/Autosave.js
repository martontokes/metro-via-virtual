        ...
        <>
          ...
          <div id="artwork_page" className="pageWithLoader">
            ...
            <Swiper
              ...
              className="autosaveSwiper"
              
            >
            
            <SwiperSlide><iframe className='autosaveVid asFirst' src="https://www.youtube.com/embed/I3Mr4dbVDy4?si=Voew6fKp45B9FeWl" allowFullScreen={true} frameBorder="no" onLoad={() => {incrementLoad(n => n + 1)}}></iframe></SwiperSlide>
            <SwiperSlide><iframe className='autosaveVid' src="https://www.youtube.com/embed/XvERO-f8wfE" allowFullScreen={true} frameBorder="no" onLoad={() => {incrementLoad(n => n + 1)}}></iframe></SwiperSlide>
            <SwiperSlide><iframe className='autosaveVid' src="https://www.youtube.com/embed/S1zhsv44qlU" allowFullScreen={true} frameBorder="no" onLoad={() => {incrementLoad(n => n + 1)}}></iframe></SwiperSlide>
            <SwiperSlide><iframe className='autosaveVid asLast' src="https://www.youtube.com/embed/hW2qJiNeotc" allowFullScreen={true} frameBorder="no" onLoad={() => {incrementLoad(n => n + 1)}}></iframe></SwiperSlide>
            </Swiper>
