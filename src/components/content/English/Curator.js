  ...
  return (
    ...
    <>
         <>
            ...
            <div id="placeholderBeforeEmail" style={{marginTop: "16px"}}></div>
            <a className="curatorEmail" style={{fontSize: "14.76px"}} href="mailto:hong.zeng@yale.edu">hong.zeng@yale.edu</a>
            <br></br><br></br>
