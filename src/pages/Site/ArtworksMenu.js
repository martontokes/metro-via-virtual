export default function ArtworksMenu({exhibitionSwiper, artworksSwiper}) {

    return (

      <>
      <div id="artworksMenu">
        <button>Domestik/Publik</button>
        <button>Illumination</button>
        <button>Confidential Records</button>
        <button>Autosave: Redoubt</button>
        <button>Butterflies on the Wheel</button>
      </div>
    </>
