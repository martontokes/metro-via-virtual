...
function ButterfliesPlayer() {
  ...
  return (
    <>
    {/* <Loader /> */}
    <iframe id="butterfliesiframe" src="/butterflies/index.html" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
