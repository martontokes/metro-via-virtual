    ...
    return (
        ...
        <>
            ...
            <div id="buddhacontainer" >
                {/* style={{height: document.querySelector(".swiper-wrapper").style.height}}  */}
                <img className="buddha" id="buddha1" src="/1.png" onLoad={() => {incrementLoad(n => n + 1)}}></img>
                <img className="buddha" id="buddha2" src="/2.png" onLoad={() => {incrementLoad(n => n + 1)}}></img>
                <img className="buddha" id="buddha3" src="/3.png" onLoad={() => {incrementLoad(n => n + 1)}}></img>
                <img className="buddha" id="buddha4" src="/4.png" onLoad={() => {incrementLoad(n => n + 1)}}></img>
                <img className="buddha" id="buddha5" src="/5.png" onLoad={() => {incrementLoad(n => n + 1)}}></img>
            </div>
            </div>
        </>
    )
