export default function Menu({swiperState}) {
    ...
    <>
      <div id="mainMenu">
        ...
        <button onClick={() => swiperState.slideTo(1, 500, false)} className="menubutton">essay</button>
        <button onClick={() => swiperState.slideTo(2, 500, false)} className="menubutton">artworks</button>
