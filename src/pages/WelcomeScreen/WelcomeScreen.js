    ...
    <>
      <div id="wcsOuterContainer">
        ...
        <div id="wcsInnerContainer">
          ...
          <button id="wcsEnterButtonEnglish" onClick={ () => enterSite(site, "english") } className="montserrat" ><span id="buttonTextEng">enter exhibition</span></button>
          ...
          <button onClick={ () => enterSite(site, "chinese") } className="notoSansHk" id="wcsEnterButtonChinese"><span id="buttonTextZh">進入展覽</span></button>
